...
The TigerTag team hosts a browser-based flasher at **<https://tigertag-project.github.io/TigerScale/>**.
...
2. Open <https://tigertag-project.github.io/TigerScale/>
...
Re-open <https://tigertag-project.github.io/TigerScale/> and click **Install** again. Your settings (Wi-Fi, Firebase, calibration) are preserved across firmware updates.
...
- 🐛 [Open an issue](https://github.com/TigerTag-Project/TigerScale/issues)
